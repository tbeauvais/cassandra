...
require 'test/unit'
require "#{File.expand_path(File.dirname(__FILE__))}/../lib/cassandra1/#{CASSANDRA_VERSION}"
begin; require 'ruby-debug'; rescue LoadError; end

begin
  @test_client = Cassandra1.new('Twitter', 'localhost:9160', :thrift_client_options => {
    :retries         => 3,
    :timeout         => 5,
    :connect_timeout => 1
  })
