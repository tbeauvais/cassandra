...
class Cassandra1
  ...
  def initialize(keyspace, servers = "127.0.0.1:9160", thrift_client_options = {})
    ...
    thrift_client_options[:transport_wrapper] ||= Cassandra1.DEFAULT_TRANSPORT_WRAPPER
  ...
  def keyspace=(ks)
    return false if Cassandra1.VERSION.to_f < 0.7
  ...
  #
  def batch(options = {})
    @batch = Cassandra1::Batch.new(self, options)
